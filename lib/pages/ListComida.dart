...
class ListaComida extends StatefulWidget {
  ...
  final String imagenBanner;
   Moneda monedEnUso;
   ListaComida({required this.listaComida, required this.imagenBanner,required this.monedEnUso});
  @override
            ...
            child: ListView.builder(
              itemCount: widget.listaComida.length,
                itemBuilder: (context, index) {
                  return BannerComida(comida: widget.listaComida[index],monedaEnUso: widget.monedEnUso,);
                },
            ),
          ),
          Positioned(
...
class BannerComida extends StatelessWidget{
  ...
  const BannerComida({super.key,required this.comida,required this.monedaEnUso});
  @override
  Widget build(BuildContext context) {
            ...
            PageRouteBuilder(
              ...
              pageBuilder: (context, animation, secondaryAnimation) {
                return FadeTransition(opacity: animation,
                  child: PaginaComida(comida: comida)
                );
              },
            ));
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child:  Text(comida.nombre,style:const TextStyle(color: Colors.white,fontSize: 28,fontWeight: FontWeight.bold),textAlign: TextAlign.left,)
                  ),
                  Container(

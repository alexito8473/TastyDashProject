...
// Secret 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
  Future<void> _enviarMensaje() async {
    ChatMessage _message= ChatMessage(text: _controller.text, person: "Usuario");
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(title: const Text("TastyGpt",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold))),
      body: SafeArea(
        child: Column(
          children: [
            Flexible(
                ...
                Expanded(
                    ...
                    Padding(
                      ...
                      child:  TextField(
                        ...
                        decoration: const InputDecoration.collapsed(hintText: "Envia un mensaje"),
                      ),
                    )
                ),
                IconButton(
